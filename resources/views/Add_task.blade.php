...
@section('Nisha','Nisha_Interview | Add Task')
@push('styles')
<style>
    ...
    <section class="content">
        <div class="container-fluid pt-3"> 
            ...
            <div class="card card-default">
                ...
                <div class="card-body">
                    <div class="col-md-12"> 
                        <form role="form" name="formaction" id="formaction" class="form-horizontal forma" method="post" action="{{url('save_task')}}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="input-group row col-sm-6">
                                    <textarea name="discre" id="discre" class="form-control discre" placeholder="Enter ..." rows="4" cols="20" onpaste="return false" oncopy="return false" maxlength="100" minlength="20" title="" data-placement="" data-toggle=""> </textarea>
